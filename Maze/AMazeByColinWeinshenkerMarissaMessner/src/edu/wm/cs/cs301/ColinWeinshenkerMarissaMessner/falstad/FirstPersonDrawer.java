...
//	Graphics gc ; // the graphics object for the buffer image this class draws on
	...
	public void redraw(GraphicsWrapper wrapper, int state, int px, int py, int view_dx, int view_dy, int walk_step, int view_offset, RangeSet rset, int ang) {
		...
		wrapper.fillSky(0, 0, view_width, view_height/2);
		// draw dark gray background on upper half
		//wrapper.setColor("dark gray");
		wrapper.fillFloor(0, view_height/2, view_width, view_height/2);
