...
public class GraphicsWrapper extends View {
	...
	public GraphicsWrapper(Context context, AttributeSet attrs) {
		super(context, attrs);
		wallBMP = BitmapFactory.decodeResource(context.getResources(), R.drawable.fallout4_wasteland_walls2_24dp);
		...
		skyBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.fallout4_wasteland_sky_24dp);
		...
		floorBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.fallout4_wasteland_floor_24dp);
